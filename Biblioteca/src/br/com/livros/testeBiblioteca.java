...
//funcao metodo principal
	public static void main(String[]args) {
		...
		emprestimo1.construtor(livro1,LocalDate.now(),LocalDate.now().plusDays(7));
		...
		livro1.emprestar();
		System.out.println("Dias restantes para devolucao do livro "+ emprestimo1.getdataDevolucao());	
		livro2.emprestar();
		System.out.println("Dias restantes para devolucao do livro "+ emprestimo2.getdataDevolucao());
		
		emprestimo1.getLivro().devolver();
		 System.out.println("Dias restantes para devolução : " + emprestimo2);
